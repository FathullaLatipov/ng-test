...
const BRANDS = [
  { name: "LEKKER", note: "Флагманский бренд · рафинированное подсолнечное масло", featured: true },
  { name: "Zlatozhar", note: "Златожар · подсолнечное масло" },
  { name: "Donskoy Yantar", note: "Донской Янтарь · подсолнечное масло" },
